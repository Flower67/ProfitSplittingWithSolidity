...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "You do not have any vested shares.");
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "Your available shares are fully vested and have been distributed.");
